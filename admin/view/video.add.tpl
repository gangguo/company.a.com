                    ...
                    <form class="form-horizontal m-t validate" method="post" action="<{$_self_url}>" id="signupForm">
                        ...
                        <{else}>
                            <div class="form-group uploader-group uploader-group-img"
                                            ...
                                            data-multiple="false"
                                            data-dir="video"
                                            data-extensions="3gp,mp4,rmvb,mov,avi,m4v"
                                            data-mimetypes="video/*,audio/*,application/*"
                                            data-chunked="true">
                                <label class="col-sm-3 control-label"> 视频:</label>
                                <div class="col-sm-8">
                                    <!--用来存放文件信息-->
                                    <div class="uploader-list"></div>
                                    <a class="btn btn-dark uploader-picker" data-file="video" data-type="video"><i class="fa fa-upload"></i> </a>
                                </div>
